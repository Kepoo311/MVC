...
import Controller.controlTambah;

/**
 *
 * @author riand
 */
public class kontakTambah extends javax.swing.JFrame {

    controlTambah cTambah;
    ...
    public kontakTambah() {
        initComponents();
        cTambah = new controlTambah(this);
    }
    ...
    private void initComponents() {
        ...
        getContentPane().add(reset, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 250, 79, -1));
        ...
        getContentPane().add(tambah, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 250, 79, -1));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(kontakTambah.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
